package com.rakeshv.serversentevents.Producer;
...
public class ServerGenerateEventsApplication {
    ...
    private static final String TOPIC = "sse-test-topic";
    private static final String BOOTSTRAP_SERVERS = "localhost:9092";
    private static final String CLIENT_ID_CONFIG = "trans-string-consumer-new";

    private final KafkaSender<String, String> sender;
    private final SimpleDateFormat dateFormat;

    public ServerGenerateEventsApplication(){
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        ServerGenerateEventsApplication producer = new ServerGenerateEventsApplication();
