...
import com.rakeshv.springrestassured.job.core.JobNotFoundException;
...
class JobsControllerTest {
    ...
    void getJobById() {
        given()
                ...
                .when()
                .get("/api/v1/jobs/{jobId}", 1)
                .then()
                .log().all()
                .statusCode(200)
                .body("id", equalTo(1))
                .body("jobTitle", containsStringIgnoringCase("GIS technical architect"))
                ;
    }
