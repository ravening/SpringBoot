...
public class DeliveryAddress extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1619064441742925650L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"DeliveryAddress\",\"namespace\":\"com.pluralsight.streaming.data.model\",\"fields\":[{\"name\":\"street\",\"type\":\"string\"},{\"name\":\"number\",\"type\":\"int\"},{\"name\":\"city\",\"type\":\"string\"}]}");
   ...
   */
  public static com.pluralsight.streaming.data.model.DeliveryAddress.Builder newBuilder() {
    return new com.pluralsight.streaming.data.model.DeliveryAddress.Builder();
  }
   ...
   * @return A new DeliveryAddress RecordBuilder
   */
  public static com.pluralsight.streaming.data.model.DeliveryAddress.Builder newBuilder(com.pluralsight.streaming.data.model.DeliveryAddress.Builder other) {
    if (other == null) {
      return new com.pluralsight.streaming.data.model.DeliveryAddress.Builder();
    } else {
      return new com.pluralsight.streaming.data.model.DeliveryAddress.Builder(other);
    }
  }
   ...
   * @return A new DeliveryAddress RecordBuilder
   */
  public static com.pluralsight.streaming.data.model.DeliveryAddress.Builder newBuilder(com.pluralsight.streaming.data.model.DeliveryAddress other) {
    if (other == null) {
      return new com.pluralsight.streaming.data.model.DeliveryAddress.Builder();
    } else {
      return new com.pluralsight.streaming.data.model.DeliveryAddress.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DeliveryAddress>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.pluralsight.streaming.data.model.DeliveryAddress.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.pluralsight.streaming.data.model.DeliveryAddress other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.street)) {
        this.street = data().deepCopy(fields()[0].schema(), other.street);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pluralsight.streaming.data.model.DeliveryAddress.Builder setStreet(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pluralsight.streaming.data.model.DeliveryAddress.Builder clearStreet() {
      street = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pluralsight.streaming.data.model.DeliveryAddress.Builder setNumber(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pluralsight.streaming.data.model.DeliveryAddress.Builder clearNumber() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pluralsight.streaming.data.model.DeliveryAddress.Builder setCity(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pluralsight.streaming.data.model.DeliveryAddress.Builder clearCity() {
      city = null;
