...
public class ServingsValue extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public com.pluralsight.streaming.servings.model.DeliveryAddress deliveryAddress;
   ...
   */
  public ServingsValue(com.pluralsight.streaming.servings.model.DeliveryAddress deliveryAddress, java.util.List<java.lang.Object> servings) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: deliveryAddress = (com.pluralsight.streaming.servings.model.DeliveryAddress)value$; break;
   ...
   */
  public com.pluralsight.streaming.servings.model.DeliveryAddress getDeliveryAddress() {
   ...
   */
  public void setDeliveryAddress(com.pluralsight.streaming.servings.model.DeliveryAddress value) {
   ...
   */
  public static com.pluralsight.streaming.servings.model.ServingsValue.Builder newBuilder() {
    return new com.pluralsight.streaming.servings.model.ServingsValue.Builder();
  }
   ...
   * @return A new ServingsValue RecordBuilder
   */
  public static com.pluralsight.streaming.servings.model.ServingsValue.Builder newBuilder(com.pluralsight.streaming.servings.model.ServingsValue.Builder other) {
    if (other == null) {
      return new com.pluralsight.streaming.servings.model.ServingsValue.Builder();
    } else {
      return new com.pluralsight.streaming.servings.model.ServingsValue.Builder(other);
    }
  }
   ...
   * @return A new ServingsValue RecordBuilder
   */
  public static com.pluralsight.streaming.servings.model.ServingsValue.Builder newBuilder(com.pluralsight.streaming.servings.model.ServingsValue other) {
    if (other == null) {
      return new com.pluralsight.streaming.servings.model.ServingsValue.Builder();
    } else {
      return new com.pluralsight.streaming.servings.model.ServingsValue.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ServingsValue>
    ...
    private com.pluralsight.streaming.servings.model.DeliveryAddress deliveryAddress;
    private com.pluralsight.streaming.servings.model.DeliveryAddress.Builder deliveryAddressBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.pluralsight.streaming.servings.model.ServingsValue.Builder other) {
      super(other);
      ...
      if (other.hasDeliveryAddressBuilder()) {
        this.deliveryAddressBuilder = com.pluralsight.streaming.servings.model.DeliveryAddress.newBuilder(other.getDeliveryAddressBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.pluralsight.streaming.servings.model.ServingsValue other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.deliveryAddress)) {
        this.deliveryAddress = data().deepCopy(fields()[0].schema(), other.deliveryAddress);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pluralsight.streaming.servings.model.ServingsValue.Builder setDeliveryAddress(com.pluralsight.streaming.servings.model.DeliveryAddress value) {
     ...
     * @return This builder.
     */
    public com.pluralsight.streaming.servings.model.DeliveryAddress.Builder getDeliveryAddressBuilder() {
      if (deliveryAddressBuilder == null) {
        if (hasDeliveryAddress()) {
          setDeliveryAddressBuilder(com.pluralsight.streaming.servings.model.DeliveryAddress.newBuilder(deliveryAddress));
        } else {
          setDeliveryAddressBuilder(com.pluralsight.streaming.servings.model.DeliveryAddress.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public com.pluralsight.streaming.servings.model.ServingsValue.Builder setDeliveryAddressBuilder(com.pluralsight.streaming.servings.model.DeliveryAddress.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pluralsight.streaming.servings.model.ServingsValue.Builder clearDeliveryAddress() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pluralsight.streaming.servings.model.ServingsValue.Builder setServings(java.util.List<java.lang.Object> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pluralsight.streaming.servings.model.ServingsValue.Builder clearServings() {
      servings = null;
    ...
    public ServingsValue build() {
      try {
        ...
        if (deliveryAddressBuilder != null) {
          ...
          record.deliveryAddress = fieldSetFlags()[0] ? this.deliveryAddress : (com.pluralsight.streaming.servings.model.DeliveryAddress) defaultValue(fields()[0]);
        }
